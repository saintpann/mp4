        ...
        <div class="header-right">
            ...
            <section class="movie-listings">
                ...
                <div class="movie-grid">
                    <a class='movieclick' href="${pageContext.request.contextPath}/movie/avengers">
                    ...
                    <a class='movieclick' href="${pageContext.request.contextPath}/movie/beautifulboy">
                        <div class="movie-card">
                    ...
                    <a class='movieclick' href="${pageContext.request.contextPath}/movie/wicked">
                        <div class="movie-card">
                    ...
                    <a class='movieclick' href="${pageContext.request.contextPath}/movie/lalaland">
                        <div class="movie-card">
