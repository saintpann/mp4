        ...
        <div class="movie-detail-container">
            <div class="movie-hero">
                <div class="movie-poster">
                    <img src="${pageContext.request.contextPath}/images/movie4.jpg" alt="La La Land">
                </div>
            ...
            <div class="showtimes-section">
                ...
                <div class="time-group">
                    ...
                    <div class="time-slots">
                        ...
                        <a href="seats?movie=lalaland&date=today&time=12:00PM" class="time-slot">12:00 PM</a>
                        <a href="seats?movie=lalaland&date=today&time=3:00PM" class="time-slot">3:00 PM</a>
                        <a href="seats?movie=lalaland&date=today&time=6:00PM" class="time-slot">6:00 PM</a>
                        <a href="seats?movie=lalaland&date=today&time=9:00PM" class="time-slot">9:00 PM</a>
                        <% } else { %>
                ...
                <div class="time-group">
                    ...
                    <div class="time-slots">
                        <% if (loggedInUser != null) { %>
                        <!-- Logged-in users see clickable buttons -->
                        <a href="seats?movie=lalaland&date=tomorrow&time=1:30PM" class="time-slot">1:30 PM</a>
                        <a href="seats?movie=lalaland&date=tomorrow&time=4:30PM" class="time-slot">4:30 PM</a>
                        <a href="seats?movie=lalaland&date=tomorrow&time=7:30PM" class="time-slot">7:30 PM</a>
                        <a href="seats?movie=lalaland&date=tomorrow&time=10:30PM" class="time-slot">10:30 PM</a>
                        <% } else { %>
                        <!-- Guests see non-clickable times -->
